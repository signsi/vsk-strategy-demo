...
<xsl:template match="checkstyle">
  <html>
    <head>
    <title>Checkstyle <xsl:value-of select="//checkstyle/@version"/> Report</title>
    <style type="text/css">
    .bannercell {
      border: 0px;
      padding: 0px;
    ...
    div {
      font:normal 70% arial,helvetica,sanserif;
      font-style:italic;
    }
    .a td {
      background: #efefef;
    ...
    <body>
      <a name="top"></a>
      <h1>Checkstyle <xsl:value-of select="//checkstyle/@version"/> Report</h1>
      <hr size="1"/>
  ...
  <xsl:template match="file">
    ...
    <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
      ...
      <tr>
        ...
        <td><xsl:value-of select="@message"/><div><xsl:value-of select="@source"/></div></td>
